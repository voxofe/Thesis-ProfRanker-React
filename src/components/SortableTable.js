...
export default function SortableTable({
  ...
  tbodyClassName = "divide-y divide-patras-cameo text-[13px] [&_tr]:transition-colors [&_tr:hover]:bg-patras-albescentWhite/25 dark:[&_tr:hover]:bg-[var(--color-bg-muted)] [&_td]:text-patras-buccaneer dark:[&_td]:text-[var(--color-text-primary)]",
  headerCellClassName = "",
