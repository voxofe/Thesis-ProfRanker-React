    ...
    <div className="space-y-3 pb-3">
      ...
      <div className="overflow-hidden rounded-md outline outline-1 -outline-offset-1 outline-patras-buccaneer/70">
        <table className="w-full border-collapse">
          <thead>
            <tr>
              <th className="w-24 border-b border-r border-gray-300 bg-gray-50 px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide text-gray-800">
                ΕΒΔΟΜΑΔΑ
              </th>
              <th className="border-b border-gray-300 bg-gray-50 px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide text-gray-800">
                ΥΛΗ ΕΒΔΟΜΑΔΑΣ
              </th>
            </tr>
          </thead>
    ...
    <TableShell>
      {COURSE_SCHEDULE_WEEK_FIELDS.map((field, index) => (
        <tr key={field.key} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
          <td className="w-24 border-b border-r border-gray-300 px-3 py-2 text-center align-middle text-sm font-semibold text-gray-700">
            {index + 1}
          </td>
          <td className="border-b border-gray-300 px-2 py-1 align-top">
            <AutoGrowTextarea
